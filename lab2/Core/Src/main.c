...
TaskHandle_t xS3Handle=NULL;
TaskHandle_t xS4Handle=NULL;
// global variable to do Inter-Task-Communication
volatile BaseType_t currentTask = 0;
// mutex to prevent critical section error
// T1
